...
def plotcbf():
    ...
    t1 = Gnuplot.Data([[i,c[i]] for i in range(128)], title="cylinder")
    t2 = Gnuplot.Data([[i,b[i]] for i in range(128)], title="bell")
    t3 = Gnuplot.Data([[i,f[i]] for i in range(128)], title="funnel")
    g.plot(t1,t2,t3)
