...
for reducdim in [10,5]:
    for c in [0,1,2]:
        ...
        for x in querydataset:
            ...
            if((treesolution <> golden.getLowestCost()) or 
                    (treesolution <> golden2.getLowestCost()) or
                    (treesolution <> golden3.getLowestCost())) : 
                print treesolution, golden.getLowestCost(), 
                print golden2.getLowestCost(),golden3.getLowestCost()
                print "BUG!!!"
                ok = False
                break
